...
# Production
	...
	ANALYTICS = True
	AWS_STATE = 'prod'
	AWS_CLOUDFRONT_KEY = 'EALMVFT6P9QEG'
	LINKED_SITE = 'origin.isobar.com'

TIME_ZONE = 'Europe/London'

CACHE_MIDDLEWARE_KEY_PREFIX = 'isobar_dk'
...
ROOT_URLCONF = 'isobar.sites.dk.urls'
AGENCY_NAME = 'Isobar Denmark'
...
FILEBROWSER_DIRECTORY = 'img/uploads/wysiwyg/dk/'
