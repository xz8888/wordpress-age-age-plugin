...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('news_story_translation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['news.Story'])),
        ))
        db.send_create_signal('news', ['StoryTranslation'])

        # Adding unique constraint on 'StoryTranslation', fields ['language_code', 'master']
        db.create_unique('news_story_translation', ['language_code', 'master_id'])
        ...
        db.create_table('news_relatedlink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('story', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_link_story', to=orm['news.Story'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('news', ['RelatedLink'])

        # Adding model 'Friend'
        db.create_table('news_friend', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('news', ['Friend'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'StoryTranslation', fields ['language_code', 'master']
        db.delete_unique('news_story_translation', ['language_code', 'master_id'])

        # Deleting model 'Category'
        db.delete_table('news_category')

        # Deleting model 'StoryTranslation'
        db.delete_table('news_story_translation')

        # Deleting model 'Story'
        db.delete_table('news_story')

        # Deleting model 'RelatedLink'
        db.delete_table('news_relatedlink')

        # Deleting model 'Friend'
        db.delete_table('news_friend')
