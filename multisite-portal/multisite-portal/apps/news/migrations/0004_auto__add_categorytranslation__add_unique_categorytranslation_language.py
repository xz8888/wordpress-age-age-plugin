...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('news_category_translation', (
            ...
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['news.Category'])),
        ))
        db.send_create_signal('news', ['CategoryTranslation'])

        # Adding unique constraint on 'CategoryTranslation', fields ['language_code', 'master']
        db.create_unique('news_category_translation', ['language_code', 'master_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CategoryTranslation', fields ['language_code', 'master']
        db.delete_unique('news_category_translation', ['language_code', 'master_id'])

        # Deleting model 'CategoryTranslation'
        db.delete_table('news_category_translation')
