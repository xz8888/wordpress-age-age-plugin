...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JobTranslation.title_i18n'
        db.add_column('jobs_job_translation', 'title_i18n', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'JobTranslation.title_i18n'
        db.delete_column('jobs_job_translation', 'title_i18n')
