...
def get_path(path):
    ...
    # If top level site-specific folder does not exist, create it
    if path == '' and not os.path.isdir(os.path.join(MEDIA_ROOT, DIRECTORY, path)):
	    os.makedirs(os.path.join(MEDIA_ROOT, DIRECTORY, path))
